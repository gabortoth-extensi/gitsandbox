		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OLIT Git sandbox",
									"targetURL": "#comolitsandbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comolitsandbox-display": {
								"semanticObject": "comolitsandbox",
								"action": "display",
								"description": "Application for Git example tasks ",
								"title": "OLIT Git sandbox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.olit.sandbox",
									"url": sap.ui.require.toUrl("com/olit/sandbox")
								}
							}
						}
					}
